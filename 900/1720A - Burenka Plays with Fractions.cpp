/*
Problem Name: Burenka Plays with Fractions
Problem Type: A - 900
...
void solve(){
    ...
    if(((ld)(x/y) == (int)(x/y)) or (((ld)(y/x) == (int)(y/x)))){
        put(1); return;
    }
    if(b==d){
        if( ((ld)(a/c) == (int)(a/c))  or ((ld)(c/a) == (int)(c/a)) ){
            put(1); return;
        }
    }
    if(a==c){
        if( ((ld)(b/d) == (int)(b/d))  or ((ld)(d/b) == (int)(d/b)) ){
            put(1); return;
        }
    }
    put(2); return;
